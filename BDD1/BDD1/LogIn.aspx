...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:Button ID="Button1" runat="server" OnClick="Button1_Click" Text="ProfesorWindow" Height="400px" Width="400px" style="font-size: xx-large; background-color: #3366FF" />
